   ...
   public Niveles(String title){
    ...
    public static JRadioButton getBtn_facil() {
        if (btn_facil == null) {
            ...
            btn_facil.addActionListener(Gestor_Niveles.getControlador());
        }
        return btn_facil;
    }
    ...
    public static JRadioButton getBtn_medio() {
        if (btn_medio == null) {
            ...
            btn_medio.addActionListener(Gestor_Niveles.getControlador());
        }
        return btn_medio;
    }
    public static JRadioButton getBtn_dificil() {
        if (btn_dificil == null) {
            ...
            btn_dificil.addActionListener(Gestor_Niveles.getControlador());
        }
        return btn_dificil;
    }
    public static JButton getBtn_volver() {
        if (btn_volver == null) {
            ...
            btn_volver.addActionListener(Gestor_Niveles.getControlador());
        }
        return btn_volver;
    }
    public static JButton getBtn_seleccionar() {
        if (btn_Seleccionar == null) {
            ...
            btn_Seleccionar.addActionListener(Gestor_Niveles.getControlador());
        }
