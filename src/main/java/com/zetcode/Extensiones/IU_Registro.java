...
public class IU_Registro extends JFrame {
    ...
    public static IU_Registro miRegistro;
    ...
    public static IU_Registro getMiRegitro() {
        if (miRegistro == null) {
            miRegistro = new IU_Registro();
        }
        return miRegistro;
    }
    ...
    private JButton getBReg() {
        if (bReg == null) {
            ...
            bReg.addActionListener(Gestor.getGestor());
        }
        return bReg;
    }
    ...
    private JButton getBLog() {
        if (bLog == null) {
            ...
            bLog.addActionListener(Gestor.getGestor());
