...
public class IU_Fondo extends JFrame {
    ...
    private JButton getBGuardar() {
        if (bGuardar == null) {
            ...
            bGuardar.addActionListener(Gestor.getGestor());
        }
        return bGuardar;
    }
    ...
    private JRadioButton getRbFondo1() {
        if (rbFondo1 == null) {
            ...
            rbFondo1.addActionListener(Gestor.getGestor());
        }
        return rbFondo1;
    }
    ...
    private JRadioButton getRbFondo2() {
        if (rbFondo2 == null) {
            ...
            rbFondo2.addActionListener(Gestor.getGestor());
        }
        return rbFondo2;
    }
    ...
    private JRadioButton getRbFondo3() {
        if (rbFondo3 == null) {
            ...
            rbFondo3.addActionListener(Gestor.getGestor());
        }
        return rbFondo3;
    }
}